...
class Opus3Migration_ThesisHabilitationAdvisorTitleInBracketsTest extends MigrationTestCase {

    protected $doc;

    public static function setUpBeforeClass()  {
        parent::setUpBeforeClass();
        parent::migrate("ThesisHabilitationAdvisorTitleInBrackets.xml");
    }
    ...
    public function testPersonAdvisor() {
        $this->assertEquals('Max', $this->doc->getPersonAdvisor(0)->getFirstName());
