...
class Opus3Migration_ThesisDoctoralEnglishTitleEnTest extends MigrationTestCase {

    protected $doc;

    public static function setUpBeforeClass()  {
        parent::setUpBeforeClass();
        parent::migrate("ThesisDoctoralEnglishTitleEn.xml");
    }
    ...
    public function testTitleMainEnglish() {
        $this->assertEquals('English Titel', $this->doc->getTitleMain(0)->getValue());
        $this->assertEquals('eng', $this->doc->getTitleMain(0)->getLanguage());
    }
    
    public function testTitleAdditionalEnglish() {
        $this->assertEquals('Second English Title', $this->doc->getTitleAdditional(0)->getValue());
        $this->assertEquals('eng', $this->doc->getTitleAdditional(0)->getLanguage());
    }
