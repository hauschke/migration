...
class Opus3Migration_ManualRestrictedTwoDocumentsTest extends MigrationTestCase {
    ...
    public static function setUpBeforeClass()  {
        ...
        parent::$stepsize = 5;
        parent::migrate("ManualTwoDocumentsEqualFilename.xml", false, true);
    }
    ...
    public function testFileCount() {
        $this->assertEquals('2', count($this->doc1->getFile()));
    ...
    public function testPathNameFile() {
        ...
        $this->assertEquals('lorem_ipsum_restricted.pdf', $this->doc1->getFile(1)->getPathName());
