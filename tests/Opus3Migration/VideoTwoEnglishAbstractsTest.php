...
class Opus3Migration_VideoTwoEnglishAbstractsTest extends MigrationTestCase {

    protected $doc;

    public static function setUpBeforeClass()  {
        parent::setUpBeforeClass();
        parent::migrate("VideoTwoEnglishAbstracts.xml");
    }
    ...
    public function testTitleAbstractEnglish() {
        $this->assertEquals($this->doc->getTitleAbstract(0)->getValue(), 'This ist the first short description.');
        $this->assertEquals($this->doc->getTitleAbstract(0)->getLanguage(), 'eng');
    }

    public function testSecondTitleAbstractEnglish() {
        $this->assertEquals($this->doc->getTitleAbstract(1)->getValue(), 'This ist the second short description.');
