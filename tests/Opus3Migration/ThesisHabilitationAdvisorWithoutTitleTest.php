...
class Opus3Migration_ThesisHabilitationAdvisorWithoutTitleTest extends MigrationTestCase {

    protected $doc;

    public static function setUpBeforeClass()  {
        parent::setUpBeforeClass();
        parent::migrate("ThesisHabilitationAdvisorWithoutTitle.xml");
    }
    ...
    public function testPersonAdvisor() {
        $this->assertEquals('Max P.', $this->doc->getPersonAdvisor(0)->getFirstName());
