...
class Opus3Migration_ThesisDoctoralGermanTitleDeTest extends MigrationTestCase {

    protected $doc;

    public static function setUpBeforeClass()  {
        parent::setUpBeforeClass();
        parent::migrate("ThesisDoctoralGermanTitleDe.xml");
    }
    ...
    public function testTitleMainGerman() {
        $this->assertEquals('Deutscher Titel', $this->doc->getTitleMain(0)->getValue());
        $this->assertEquals('deu', $this->doc->getTitleMain(0)->getLanguage());
    }

    public function testTitleAdditionalGerman() {
        $this->assertEquals('zweiter Deutscher Titel', $this->doc->getTitleAdditional(0)->getValue());
        $this->assertEquals('deu', $this->doc->getTitleAdditional(0)->getLanguage());
    }
